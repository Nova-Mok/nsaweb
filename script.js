...
` +
        ...
        function p() {
          var E = e('<a class="w-webflow-badge"></a>').attr(
            ...
            T = e("<img>")
              ...
              .attr("alt", "")
              .css({ marginRight: "0px", width: "26px" }),
            O = e("")
              .attr("alt", "Made in NSA");
            ...
            handler: (
              ...
              switch (a) {
                ...
                case at.PAGE: {
                  ...
                  S = O ? Math.min(M + E, q) / q : Math.min(D + T, B) / B;
                  break;
                }
                case at.ELEMENT:
                default: {
  ...
  function _V({ logic: e, store: t, events: r }) {
    ...
    (0, yr.default)(s, (p, m) => {
      ...
      QU(F, o.mediaQueryKeys) || t.dispatch(ss()),
        ...
        (T.actionTypeId === ke.GENERAL_START_ACTION || bs(T.actionTypeId)) &&
        ...
        let { config: m, actionTypeId: E } = p,
          T =
            m?.target?.useEventTarget === !0 && m?.target?.objectId == null
              ...
              : m,
          O = wi({ config: T, event: s, elementApi: qe }),
          F = Ai(E);
        O.forEach((S) => {
  ...
  function ws(e) {
    let { store: t, computedStyle: r, ...n } = e,
      ...
      { refState: S } = E[F] || {},
      P = fs(i),
      A = T.reducedMotion && zo[o.actionTypeId],
      M;
    if (A && u)
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "65a6e4a183f85cf70e4002d8|51e96a77-d16f-a485-df6d-ee49b748098b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
