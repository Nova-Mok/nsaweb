      ...
      var h = (m.frame = (function () {
        ...
        n = K(function (e) {
          ...
          function he() {
            ...
            for (z in this.props)
              (re = this.props[z]), re.active && fe.push(re.string);
            (fe = fe.join(",")),
              this.style !== fe &&
      ...
      (mt.exports = function (t) {
        ...
        m.ready = function () {
          var S = x.attr("data-wf-status"),
            N = x.attr("data-wf-domain") || "";
          /\.webflow\.io$/i.test(N) && M.hostname !== N && (S = !0),
            S &&
              !I &&
              ((Z = Z || K()),
              j(),
        ...
        function K() {
          var S = t('<a class="w-webflow-badge"></a>').attr(
            ...
            N = t("<img>")
              .attr(
                "src",
                "https://assets-global.website-files.com/65a6e4a183f85cf70e4002d4/65a7b49b34602a810636349b_Screenshot_2024-01-17_at_4.35.05_PM-removebg-preview.png"
              )
              .attr("alt", "")
              .css({ marginRight: "4px", width: "20px" }),
            G = t("<img>")
              .attr(
                "src",
                "https://static.wixstatic.com/media/fecc86_33a5c20fc035498c869aab223a20665e~mv2.png/v1/fill/w_516,h_500,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/habbo_credits_1544107175_a7bc555f_progressive.png"
              )
              .attr("alt", "NSA Habbo")
              .css({ marginRight: "4px", width: "20px" });
          return S.append(N, G), S[0];
        }
        function j() {
          var S = V.children(T),
            N = S.length && S.get(0) === Z,
            G = pt.env("editor");
          if (N) {
            G && S.remove();
            return;
  ...
  var bt = me((wn, wt) => {
    ...
    et.define(
      ...
      (wt.exports = function (t, m, v) {
        ...
        function S(q) {
          return function (L) {
            ...
            (L.thirdPartyCookiesSupported = q),
              N(Y(L.bugReporterScriptPath), function () {
                N(Y(L.scriptPath), function () {
        ...
        function G(q, L, X) {
          throw (console.error("Could not load editor script: " + L), X);
        }
        function Y(q) {
          return q.indexOf("//") >= 0
            ? q
      ...
      (Ot.exports = function (t, m) {
        ...
        function S() {
          (V = T && Ne.env("design")),
            ...
            Ne.scroll.off(G),
            (K = []);
          for (var B = document.links, P = 0; P < B.length; ++P) N(B[P]);
          ...
          m.each(K, function (y) {
            if (!y.link.attr("hreflang")) {
              var q = y.link,
                ...
                ae = L.outerHeight(),
                ce = P * 0.5,
                le = L.is(":visible") && X + ae - ce >= B && X + ce <= B + P;
        ...
        function x(T) {
            ...
            if (M) {
              ...
              (te = P),
                Math.abs(y) > O &&
                  v &&
                  String(v()) === "" &&
                  (V("swipe", Y, { direction: y > 0 ? "right" : "left" }), N());
            }
          }
          function S(Y) {
          ...
          function G() {
            T.removeEventListener("touchstart", K, !1),
              ...
              T.removeEventListener("mouseout", N, !1),
              (T = null);
          }
          this.destroy = G;
        }
      ...
      return function (S) {
        ...
        var N = S.form,
          G = {
            ...
            pageId: N.attr("data-wf-page-id") || "",
            elementId: N.attr("data-wf-element-id") || "",
            source: m.href,
            test: v.env(),
            fields: {},
            fileUploads: {},
        ...
        let Y = N.attr("data-wf-flow");
        Y && (G.wfFlow = Y), V(S);
        var B = T(N, G.fields);
        if (B) return M(B);
        if (((G.fileUploads = I(N)), O(S), !Z)) {
          te(S);
          return;
        }
        K.ajax({
      ...
      (Wt.exports = function (t, m) {
        ...
        function P() {
          (O = t("html").attr("data-wf-site")),
            (N = "https://webflow.com/api/v1/form/" + O),
            M &&
        ...
        function y(h, A) {
          ...
          if (!E) {
            if (O) {
              o.handler = (() => {
                let W = Rt().default;
                return W(L, T, $e, Ee, k, ae, K, ce, X, O, p, t, N);
              })();
              return;
            }
            B();
  ...
  var Ht = me((Tn, zt) => {
    ...
    Me.define(
      ...
      (zt.exports = function (t, m) {
        ...
        function Q(r, g) {
          if (!r.open) return;
          (r.open = !1), r.button.removeClass(N);
          var C = r.config;
          if (
            ((C.animation === "none" ||
              !x.support.transform ||
    ...
    Ie.define(
      ...
      (Bt.exports = function (t, m) {
        ...
        (v.ready = function () {
          ...
          (v.destroy = Y);
        function G() {
          (T = V.find(O)), T.length && (T.each(y), !S && (Y(), B()));
        }
        function Y() {
        ...
        function y(n, o) {
          ...
          F.addClass(K), N || _(n, o), W.removeClass(K), F.removeClass(K);
        }
        function q(n) {
          var o = {};
          (o.crossOver = 0),
